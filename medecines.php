...
<html>
    ...
    <div class="parallax-content baner-content" id="home">
        <div class="container">
            <div class="first-content">
                <h1>Needs!</h1>
                <span><em>Confirmed</em> availability of medicines!</span>
  ...
  <form method="post">
    ...
    <h1>Please fill in this form to avail our services</h1>
    <hr>
    ...
    <label for="med"><b>Medecine name</b></label>
    <input type="text" placeholder="Enter medecine name" name="med" id="med" required>
...
$sql = "INSERT INTO `medecines`(`name`, `email`,`med`) VALUES ('$name','$email','$med')";//sql query
